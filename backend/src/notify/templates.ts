export const tmpl = {
  appointmentBooked: (petName: string, vetName: string, whenISO: string) => ({
...
<p>Thank you for using VetCare+.</p>`
  ...
  appointmentReminder: (petName: string, vetName: string, whenISO: string) => ({
...
<p>See you soon!</p>`
  ...
  vaccinationDue: (petName: string, vaccine: string, dueISO: string) => ({
